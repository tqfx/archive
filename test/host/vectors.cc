...
static a_noret_t test(a_noarg_t)
{
    ...
    {
        a_u64_t *p = a_cast(a_u64_t *, a_vectors_push(ctx));
        if (p)
        {
            *p = i;
        }
    ...
    {
        a_u32_t *p = a_cast(a_u32_t *, a_vectors_push(ctx));
        if (p)
        {
            *p = i;
        }
    ...
    {
        a_byte_t *end = a_cast(a_byte_t *, a_vectors_end(ctx));
        a_byte_t *top = a_cast(a_byte_t *, a_vectors_top(ctx));
        TEST_BUG(a_vectors_get(ctx) == a_cast(a_size_t, end - top));
    }
    ...
    {
        a_u32_t *it = a_cast(a_u32_t *, a_vectors_at(ctx, i));
...

    {
        ...
        {
            a_u32_t *p = a_cast(a_u32_t *, a_vectors_insert(ctx, i));
            if (p)
            {
                *p = i;
            }
        ...
        for (a_u32_t i = 0; i != 5; ++i)
        {
            a_u32_t *p = a_cast(a_u32_t *, a_vectors_remove(ctx, i));
            if (p)
            {
                printf("%" PRIu32 " ", *p);
            }
        ...
        for (a_u32_t i = 0; i != 5; ++i)
        {
            a_u32_t *p = a_cast(a_u32_t *, a_vectors_remove(ctx, 0));
            if (p)
            {
                printf("%" PRIu32 " ", *p);
            }
    ...
    }
    {
        ...
        for (a_u32_t i = 5; i != 10; ++i)
        {
            a_u32_t *p = a_cast(a_u32_t *, a_vectors_push_back(ctx));
            if (p)
            {
                *p = i;
            }
        ...
        for (a_u32_t i = 5; i != 10; ++i)
        {
            a_u32_t *p = a_cast(a_u32_t *, a_vectors_pull_back(ctx));
            if (p)
            {
                printf("%" PRIu32 " ", *p);
            }
        ...
        for (a_u32_t i = 0; i != 5; ++i)
        {
            a_u32_t *p = a_cast(a_u32_t *, a_vectors_push_fore(ctx));
            if (p)
            {
                *p = i;
            }
        ...
        for (a_u32_t i = 0; i != 5; ++i)
        {
            a_u32_t *p = a_cast(a_u32_t *, a_vectors_pull_fore(ctx));
            if (p)
            {
                printf("%" PRIu32 " ", *p);
            }
