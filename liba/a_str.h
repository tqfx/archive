...
/*!
 ...
 @return string
*/
const char *a_str_val(a_str_t *_ctx)
{
    aassert(_ctx);
    return _ctx->s;
}
...
/*!
 ...
 @return a_str_t *
*/
extern a_str_t *a_str_init(const void *p, size_t n) __RESULT_USE_CHECK;
...
*/
extern char *a_str_done(a_str_t *ctx) __NONNULL_ALL __RESULT_USE_CHECK;

/*!
 @brief Free a pointer to c string structure
 @param[in] ctx: points to an instance of c string structure
*/
extern void a_str_free(a_str_t *ctx);
...
/*!
 ...
 @return the execution state of the function
  ...
  @retval 0 success
*/
extern int a_str_resize(a_str_t *ctx, size_t m) __NONNULL((1));
extern int a_str_resize_(a_str_t *ctx, size_t m) __NONNULL((1));
...
/*!
 ...
 @return the execution state of the function
  ...
  @retval 0 success
*/
extern int a_str_putn(a_str_t *ctx, const void *p, size_t n) __NONNULL((1));
extern int a_str_putn_(a_str_t *ctx, const void *p, size_t n) __NONNULL((1));
...
/*!
 ...
 @return the execution state of the function
  ...
  @retval 0 success
*/
extern int a_str_puts(a_str_t *ctx, const char *s) __NONNULL_ALL;
...
/*!
 ...
 @return character
  @retval -1 failure
*/
extern int a_str_putc(a_str_t *ctx, int c) __NONNULL((1));
extern int a_str_putc_(a_str_t *ctx, int c) __NONNULL((1));
...
/*!
 ...
 @return number of print
  @retval -1 failure
*/
extern int a_str_vprintf(a_str_t *ctx, const char *fmt, va_list ap) __ATTR_PRINTF(2, 0);
...
/*!
 ...
 @return number of print
  @retval -1 failure
*/
extern int a_str_printf(a_str_t *ctx, const char *fmt, ...) __ATTR_PRINTF(2, 3);
