...
extern void a_sha1_init(a_sha1_s *ctx) __NONNULL_ALL;
extern int a_sha1_process(a_sha1_s *ctx, const void *p, size_t n) __NONNULL((1));
extern unsigned char *a_sha1_done(a_sha1_s *ctx, void *out) __NONNULL((1));
