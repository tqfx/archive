...
extern void a_md5_init(a_md5_s *ctx) __NONNULL_ALL;
extern int a_md5_process(a_md5_s *ctx, const void *p, size_t n) __NONNULL((1));
extern unsigned char *a_md5_done(a_md5_s *ctx, void *out) __NONNULL((1));
