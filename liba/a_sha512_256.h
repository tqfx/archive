...
#define A_SHA512_256_DIGESTSIZE 0x20

#define a_sha512_256_t a_sha512_t

/*!
 @brief          Compress function for SHA512_256.
 @param[in,out]  ctx: points to an instance of SHA512_256.
 @param[in]      buf: points to buffer(512-bits).
*/
#define a_sha512_256_compress(ctx, buf) a_sha512_compress(ctx, buf)

/*!
 @brief          Process function for SHA512_256.
 @param[in,out]  ctx: points to an instance of SHA512_256.
...
/*!
 @brief          Initialize function for SHA512_256.
 @param[in,out]  ctx: points to an instance of SHA512_256.
*/
extern void a_sha512_256_init(a_sha512_256_t *ctx);

/*!
 @brief          Terminate function for SHA512_256.
 @param[in,out]  ctx: points to an instance of SHA512_256.
...
/*!
 @brief          Created SHA512_256 hash from a string of characters on hex encoding.
