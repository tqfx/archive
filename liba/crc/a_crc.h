...
uint8_t a_crc8(const uint8_t tab[0x100], const void *p, size_t n, uint8_t crc);

void a_crc16_lsb(uint16_t tab[0x100], uint16_t poly);
void a_crc16_msb(uint16_t tab[0x100], uint16_t poly);
uint16_t a_crc16l(const uint16_t tab[0x100], const void *p, size_t n, uint16_t crc);
uint16_t a_crc16h(const uint16_t tab[0x100], const void *p, size_t n, uint16_t crc);

void a_crc32_lsb(uint32_t tab[0x100], uint32_t poly);
void a_crc32_msb(uint32_t tab[0x100], uint32_t poly);
uint32_t a_crc32l(const uint32_t tab[0x100], const void *p, size_t n, uint32_t crc);
uint32_t a_crc32h(const uint32_t tab[0x100], const void *p, size_t n, uint32_t crc);

void a_crc64_lsb(uint64_t tab[0x100], uint64_t poly);
void a_crc64_msb(uint64_t tab[0x100], uint64_t poly);
uint64_t a_crc64l(const uint64_t tab[0x100], const void *p, size_t n, uint64_t crc);
uint64_t a_crc64h(const uint64_t tab[0x100], const void *p, size_t n, uint64_t crc);
