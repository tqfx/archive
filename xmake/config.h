...
${define A_HAVE_C_RESTRICT}
${define A_HAVE_C_STATIC_ASSERT}
${define A_HAVE_C_VARIADIC_MACROS}
${define A_HAVE_CXX_NULLPTR}
${define A_HAVE_CXX_STATIC_ASSERT}
${define A_HAVE_CXX_VARIADIC_MACROS}
