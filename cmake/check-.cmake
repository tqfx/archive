...
elseif("${CMAKE_C_COMPILER_ID}" MATCHES "MSVC" OR "${CMAKE_CXX_COMPILER_ID}" MATCHES "MSVC")
  ...
  if("${VCPKG_TARGET_TRIPLET}" MATCHES "x?[86]?[64]-windows-static")
    append_option(CMAKE_CXX_FLAGS_DEBUG /MTd)
    append_option(CMAKE_CXX_FLAGS_RELEASE /MT)
    append_option(CMAKE_CXX_FLAGS_MINSIZEREL /MT)
    append_option(CMAKE_CXX_FLAGS_RELWITHDEBINFO /MT)
  endif()
endif()
