...
target("a.objs")
    ...
    configvar_check_features("A_HAVE_C_RESTRICT", "c_restrict")
    configvar_check_features("A_HAVE_C_STATIC_ASSERT", "c_static_assert")
    configvar_check_features("A_HAVE_C_VARIADIC_MACROS", "c_variadic_macros")
    configvar_check_features("A_HAVE_CXX_NULLPTR", "cxx_nullptr")
    configvar_check_features("A_HAVE_CXX_STATIC_ASSERT", "cxx_static_assert")
    configvar_check_features("A_HAVE_CXX_VARIADIC_MACROS", "cxx_variadic_macros")
    configvar_check_csnippets("A_HAVE_RESTRICT", "void _(void *__restrict p);")
