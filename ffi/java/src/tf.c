...
JNIEXPORT jobject JNICALL Java_liba_ac_00024tf_init(JNIEnv *jenv, jobject jobj, jdoubleArray jnum, jdoubleArray jden)
{
    j_tf_s jctx[1];
...
JNIEXPORT jdouble JNICALL Java_liba_ac_00024tf_proc(JNIEnv *jenv, jobject jobj, jdouble jx)
{
    a_tf_s ctx[1];
    j_tf_s jctx[1];
...
JNIEXPORT jobject JNICALL Java_liba_ac_00024tf_zero(JNIEnv *jenv, jobject jobj)
{
    a_tf_s ctx[1];
    j_tf_s jctx[1];
    j_tf_get(j_tf_new(jenv, jobj, jctx), ctx);
