...
*/
A_INTERN a_vptr_t a_arr_ptr(a_arr_s const *const ctx) { return ctx->_ptr; }

/*!
 @brief access number of element for a pointer to array structure
 @param[in] ctx points to an instance of array structure
*/
A_INTERN a_size_t a_arr_num(a_arr_s const *const ctx) { return ctx->_num; }

/*!
 @brief access memory of element for a pointer to array structure
 @param[in] ctx points to an instance of array structure
*/
A_INTERN a_size_t a_arr_mem(a_arr_s const *const ctx) { return ctx->_mem; }

/*!
 @brief access size of a element for a pointer to array structure
 @param[in] ctx points to an instance of array structure
*/
A_INTERN a_size_t a_arr_get(a_arr_s const *const ctx) { return ctx->_siz; }
...
*/
A_INTERN a_vptr_t a_arr_at_(a_arr_s const *const ctx, a_size_t const idx)
{
...
*/
A_INTERN a_vptr_t a_arr_at(a_arr_s const *const ctx, a_size_t const idx)
{
...
/*!
 ...
 @return specified element pointer
  @retval 0 out of bounds
*/
A_INTERN a_vptr_t a_arr_idx(a_arr_s const *const ctx, a_diff_t const idx)
{
...
/*!
 ...
 @return specified element pointer
*/
A_INTERN a_vptr_t a_arr_top_(a_arr_s const *const ctx)
{
...
*/
A_INTERN a_vptr_t a_arr_top(a_arr_s const *const ctx)
{
...
*/
A_INTERN a_vptr_t a_arr_end(a_arr_s const *const ctx)
{
...
*/
A_EXTERN a_void_t a_arr_swap(a_arr_s const *ctx, a_size_t lhs, a_size_t rhs);
...
*/
A_EXTERN a_void_t a_arr_sort(a_arr_s const *ctx, a_int_t (*cmp)(a_cptr_t, a_cptr_t));
...
/*!
 ...
 @param[in] cmp a function that compares two elements
  ...
  @arg cmp(lhs,rhs)>0 *lhs goes after *rhs
*/
A_EXTERN a_void_t a_arr_sort_fore(a_arr_s const *ctx, a_int_t (*cmp)(a_cptr_t, a_cptr_t));
...
/*!
 ...
 @param[in] cmp a function that compares two elements
  ...
  @arg cmp(lhs,rhs)>0 *lhs goes after *rhs
*/
A_EXTERN a_void_t a_arr_sort_back(a_arr_s const *ctx, a_int_t (*cmp)(a_cptr_t, a_cptr_t));
...
/*!
 ...
 @return matching element pointer
  @retval 0 failure
*/
A_EXTERN a_vptr_t a_arr_search(a_arr_s const *ctx, a_cptr_t obj, a_int_t (*cmp)(a_cptr_t, a_cptr_t));

/*!
 @brief insert an element into the array
 @param[in] ctx points to an instance of array structure
 @param[in] idx index of element in this array
  @arg 0 a_arr_push_fore
  @arg n a_arr_push_back
...
/*!
 ...
 @param[in] ctx points to an instance of array structure
 @param[in] idx index of element in this array
  @arg 0 a_arr_pull_fore
  @arg n a_arr_pull_back
 @return element pointer
  @retval 0 failure
*/
