...
*/
A_PUBLIC a_real_t a_polytrack3_pos(const a_polytrack3_s *ctx, a_real_t t);
...
*/
A_PUBLIC a_real_t a_polytrack3_vec(const a_polytrack3_s *ctx, a_real_t t);
...
*/
A_PUBLIC a_real_t a_polytrack3_acc(const a_polytrack3_s *ctx, a_real_t t);
...
*/
A_PUBLIC void a_polytrack3_all(const a_polytrack3_s *ctx, a_real_t t, a_real_t out[3]);
...
/*!
 ...
 @return position output
*/
A_PUBLIC a_real_t a_polytrack5_pos(const a_polytrack5_s *ctx, a_real_t t);
...
/*!
 ...
 @return velocity output
*/
A_PUBLIC a_real_t a_polytrack5_vec(const a_polytrack5_s *ctx, a_real_t t);
...
/*!
 ...
 @return acceleration output
*/
A_PUBLIC a_real_t a_polytrack5_acc(const a_polytrack5_s *ctx, a_real_t t);
...
/*!
 ...
 @param[out] out buffer for result
  ...
  @arg 2 acceleration output
*/
A_PUBLIC void a_polytrack5_all(const a_polytrack5_s *ctx, a_real_t t, a_real_t out[3]);
...
/*!
 ...
 @return position output
*/
A_PUBLIC a_real_t a_polytrack7_pos(const a_polytrack7_s *ctx, a_real_t t);
...
/*!
 ...
 @return velocity output
*/
A_PUBLIC a_real_t a_polytrack7_vec(const a_polytrack7_s *ctx, a_real_t t);
...
/*!
 ...
 @return acceleration output
*/
A_PUBLIC a_real_t a_polytrack7_acc(const a_polytrack7_s *ctx, a_real_t t);
...
/*!
 ...
 @return jerk output
*/
A_PUBLIC a_real_t a_polytrack7_jer(const a_polytrack7_s *ctx, a_real_t t);
...
/*!
 ...
 @param[out] out buffer for result
  ...
  @arg 3 jerk output
*/
A_PUBLIC void a_polytrack7_all(const a_polytrack7_s *ctx, a_real_t t, a_real_t out[4]);
