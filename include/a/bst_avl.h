...
#ifndef LIBA_BST_AVL_H
#define LIBA_BST_AVL_H

#include "a.h"

/*!
 @ingroup A
 @addtogroup A_BST_AVL AVL binary search tree
 @{
*/
...
*/
typedef struct a_bst_avl_s
{
    /*!< pointer to left child or NULL */
    struct a_bst_avl_s *left;
    /*!< pointer to right child or NULL */
    struct a_bst_avl_s *right;
...
*/
typedef union a_bst_avl_u
{
    struct a_bst_avl_s *node; //!< root node
} a_bst_avl_u;
...
*/
A_INTERN a_void_t a_bst_avl_root(a_bst_avl_u *const root) { root->node = A_NULL; }
...
*/
A_EXTERN a_bst_avl_s *a_bst_avl_next(a_bst_avl_s *node);
...
*/
A_EXTERN a_bst_avl_s *a_bst_avl_prev(a_bst_avl_s *node);
...
/*!
 ...
 @return next node or NULL
*/
A_EXTERN a_bst_avl_s *a_bst_avl_pre_next(a_bst_avl_s *node);
...
/*!
 ...
 @return prev node or NULL
*/
A_EXTERN a_bst_avl_s *a_bst_avl_pre_prev(a_bst_avl_s *node);
...
/*!
 ...
 @return next node or NULL
*/
A_EXTERN a_bst_avl_s *a_bst_avl_post_next(a_bst_avl_s *node);
...
/*!
 ...
 @return prev node or NULL
*/
A_EXTERN a_bst_avl_s *a_bst_avl_post_prev(a_bst_avl_s *node);
...
*/
A_EXTERN a_bst_avl_s *a_bst_avl_tear(a_bst_avl_u *root, a_bst_avl_s **next);
...
*/
A_EXTERN a_bst_avl_s *a_bst_avl_insert(a_bst_avl_u *root, a_bst_avl_s *node, a_int_t (*cmp)(a_cptr_t, a_cptr_t));
...
*/
A_EXTERN a_void_t a_bst_avl_insert_adjust(a_bst_avl_u *root, a_bst_avl_s *node);
...
/*!
 ...
 @param[in] node specified tree node
*/
A_EXTERN a_void_t a_bst_avl_remove(a_bst_avl_u *root, a_bst_avl_s *node);
...
/*!
 ...
 @param ptr the &a_bst_avl_s pointer
 @param type the type of the struct this is embedded in
 @param member the name of the a_bst_avl_s within the struct
*/
#define a_bst_avl_entry(ptr, type, member) a_container_of(ptr, type, member)

/*!
 @brief iterate over a AVL binary search tree in-order
 @code{.c}
 typedef struct { a_bst_avl_u node; } T;
 a_bst_avl_u root = A_BST_AVL_ROOT;
 a_bst_avl_foreach(cur, &root)
 {
     T *it = a_bst_avl_entry(cur, T, node);
 }
 @endcode
 @param cur the &a_bst_avl_s to use as a loop counter
 @param root AVL binary search tree root
*/
#define a_bst_avl_foreach(cur, root) \
    for (a_bst_avl_s *cur = a_bst_avl_head(root); cur; cur = a_bst_avl_next(cur))
...
/*!
 ...
 @param root AVL binary search tree root
*/
#define a_bst_avl_foreach_reverse(cur, root) \
    for (a_bst_avl_s *cur = a_bst_avl_tail(root); cur; cur = a_bst_avl_prev(cur))
...
/*!
 ...
 @param root AVL binary search tree root
*/
#define a_bst_avl_pre_foreach(cur, root) \
    for (a_bst_avl_s *cur = (root)->node; cur; cur = a_bst_avl_pre_next(cur))
...
/*!
 ...
 @param root AVL binary search tree root
*/
#define a_bst_avl_pre_foreach_reverse(cur, root) \
    for (a_bst_avl_s *cur = (root)->node; cur; cur = a_bst_avl_pre_prev(cur))
...
/*!
 ...
 @param root AVL binary search tree root
*/
#define a_bst_avl_post_foreach(cur, root) \
    for (a_bst_avl_s *cur = a_bst_avl_post_head(root); cur; cur = a_bst_avl_post_next(cur))
...
/*!
 ...
 @param root AVL binary search tree root
*/
#define a_bst_avl_post_foreach_reverse(cur, root) \
    for (a_bst_avl_s *cur = a_bst_avl_post_tail(root); cur; cur = a_bst_avl_post_prev(cur))

/*! @} A_BST_AVL */

#endif /* LIBA_BST_AVL_H */
